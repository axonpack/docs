...
<Callout type="info">
  ...
  install would only make you guess which half of this site is real. What is being considered next is
  in [the repository's plan](https://github.com/axonpack/axonpack/blob/main/notes/plan.md).
</Callout>
